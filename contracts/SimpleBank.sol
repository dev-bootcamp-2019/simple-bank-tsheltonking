...
contract SimpleBank {
    ...
    function balance() public view returns (uint) {                                                                   //Added View
        ...
        return balances[msg.sender]; /* Get the balance of the sender of this transaction */            //return msg.sender.balance;
    ...
    // Emit the appropriate event    
    function deposit() public payable returns (uint) {                                                                   //Payable
